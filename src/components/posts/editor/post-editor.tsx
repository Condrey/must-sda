...
import { Loader2Icon, Paperclip, XIcon } from "lucide-react";
import Image from "next/image";
import { ClipboardEvent, useRef } from "react";
import { useSubmitPostMutation } from "./mutation";
import "./styles.css";
import UseMediaUploads, { Attachment } from "./use-media-uploads";
  ...
  return (
    <div className="flex flex-col gap-5 rounded-2xl bg-card p-5 shadow-sm">
      <div className="flex gap-5">
        ...
        <div {...routeprops} className="w-full">
          <EditorContent
            editor={editor}
            onPaste={onPaste}
            className={cn(
    ...
    >
      {file.type.startsWith("image") ? (
        <Image
          ...
          width={500}
          height={500}
          className="size-fit min-h-[30rem] rounded-2xl"
        />
      ) : (
